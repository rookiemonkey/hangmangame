...
:see_no_evil: A web version of the original paper/pencil guessing game 'Hangman' https://en.wikipedia.org/wiki/Hangman_(game)

Consider checking the repo's issues, all of my todos are in there :smile:

![Screenshot](./hangman1.png)
![Screenshot](./hangman2.png)
